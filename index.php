...
<head>
    ...
    <style>
        body {
            background-image: url('images/2328047.jpg');
...
<body>
    <h1 class="glow">COURIER MANAGEMENT SERVICE</h1>
    <hr />
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" method="post">
                    <div class="form-group"  style="color:white;" id="glowtext">
                        <label>Email Address</label>
                        <input type="email" name="email" class="form-control" placeholder="Enter Username/EmailId" required />
                    </div>
                    <div class="form-group" id="glowtext" style="color:white;">
